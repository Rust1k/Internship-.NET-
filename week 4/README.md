...
[Async and Await QnA](Async%20and%20Await%20QnA.pdf)

### Links
1. [Async/await and Implementation Mechanism in C# 5.0](https://habr.com/ru/post/260217/)
2. [Async/await in C#: Pitfalls](https://habr.com/ru/post/257221/)
3. [Async programming in .NET: Best practices](https://habr.com/ru/company/jugru/blog/491236/)
4. [Async/Await - Best Practices in Asynchronous Programming](https://docs.microsoft.com/en-us/archive/msdn-magazine/2013/march/async-await-best-practices-in-asynchronous-programming)
5. [There Is No Thread](https://blog.stephencleary.com/2013/11/there-is-no-thread.html)

### Exercises
[Async task](Async%20task.md)    
[IAsyncEnumerable exercise.md](IAsyncEnumerable%20exercise.md)
